...
import com.nightCloud.shanda.controller.ScoringResultController;
import com.nightCloud.shanda.exception.ThrowUtils;
import com.nightCloud.shanda.mapper.ScoringResultMapper;
...
public class ScoringResultServiceImpl extends ServiceImpl<ScoringResultMapper, ScoringResult> implements ScoringResultService {
    ...
    public void validScoringResult(ScoringResult scoringResult, boolean add) {
        ...
        if (appId != null) {
            App app = aqqService.getById(appId);
